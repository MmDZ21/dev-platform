...
import AnimatedFeatures from "@/themes/ranin-v2/blocks/features";
import advice from "@/themes/ranin-v2/assets/images/advice.png";
import delivery from "@/themes/ranin-v2/assets/images/delivery.png";
import { Slot, Slots } from "@/lib/simple-theme";
    ...
    <MainLayout slots={slots} page={page}>
      ...
      <div className="space-y-0">
        ...
        <div className="parallax-break">
          <Slots slots={slots} name="parallax" />
        </div>
        ...
        <div className="space-y-0">
          <Slots slots={slots} name="sections" />
        </div>

        {/* Newsletter Section */}
        <div className="newsletter-section">
          <Slots slots={slots} name="newsletter" />
        </div>
        ...
        {/* <Section>
          <Container className="py-10">
            <Slots slots={slots} name="content" />
          </Container>
        </Section> */}
      </div>
    </MainLayout>
