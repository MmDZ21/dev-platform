...
import { Button, useEnterAnimation } from "../design-system";
import Link from "next/link";

export const parallaxSectionSchema = z.object({
  image: z.string().min(1, "Image URL is required").default(parallaxImage.src || "/images/relay.png"),
...
export function ParallaxSection(
  ...
  const imageSrc = image || parallaxImage.src || "/images/relay.png";
    ...
    >
      ...
      {hasContent && (
        ...
        >
          ...
          {subtitle && (
            <motion.p 
              className="mx-auto mb-6 md:mb-8 max-w-2xl text-sm md:text-xl opacity-90 leading-relaxed"
              variants={variants.fadeInUp}
            >
              {subtitle}
            </motion.p>
