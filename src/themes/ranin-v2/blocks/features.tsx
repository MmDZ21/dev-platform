...
import { Heading, FullScreenSection, useEnterAnimation } from "../design-system";
...
export function AnimatedFeatures({
  ...
  return (
    ...
    >
      <motion.div 
        ref={ref}
        className={`mx-auto flex h-full w-full max-w-7xl xl:max-w-[1400px] 2xl:max-w-[1600px] items-center justify-between ${contentOrder} py-8 md:py-16`}
        initial="offscreen"
        animate={animate}
        variants={variants.container}
      >
        
        <motion.div className={`flex-1 mb-8 md:mb-0 ${textPadding}`} variants={variants.fadeInUp}>
          {sectionTitle && (
            <motion.div
