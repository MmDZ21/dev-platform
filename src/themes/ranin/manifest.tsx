...
const manifest: ThemeManifest = {
  ...
  defaultLayout: "home",
  layouts: {
    home: { key: "home", slots: ["nav", "hero", "highlights", "sections", "footer"], Component: HomeLayout },
    products: { key: "products", slots: ["nav", "filters", "content", "footer"], Component: ProductsLayout },
  },
  blocks: {
