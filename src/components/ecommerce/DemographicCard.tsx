...
const CountryMap = dynamic(() => import("@/components/ecommerce/CountryMap"), { ssr: false });
      ...
      <div className="space-y-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            <div className="relative block h-2 w-full max-w-[100px] rounded_sm bg-gray-200 dark:bg-gray-800">
